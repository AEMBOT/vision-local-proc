...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_hue = [24.280575539568343, 51.64685908319185]
        self.__hsl_threshold_saturation = [87.14028776978417, 209.54159592529712]
        self.__hsl_threshold_luminance = [84.84712230215827, 198.71816638370123]

        self.hsl_threshold_output = None

        self.__mask_0_mask = self.hsl_threshold_output

        self.mask_0_output = None

        self.__rgb_threshold_input = self.mask_0_output
        self.__rgb_threshold_red = [153.64208633093526, 233.35314091680814]
        self.__rgb_threshold_green = [149.05575539568343, 246.34125636672326]
        ...
        self.__filter_contours_min_area = 111.0
